...
public class BigNumber {
	...
	public BigNumber baseConvert (BigNumber a, BigNumber base){

		BigNumber result = new BigNumber();
		BigNumber quotient = divide(a, base);
		BigNumber remainder = mod(a, base);
		BigNumber temp;
	...
	BigNumber splitBigNumber(int fromIndex, int toIndex) {
	...
	public BigNumber addUtil(BigNumber num1, BigNumber num2) {
		BigNumber res = new BigNumber();
	...
	public BigNumber subtractUtil(BigNumber num1, BigNumber num2) {
		BigNumber res = new BigNumber();
		ArrayList<Long> x = num1.digits;
		ArrayList<Long> y = num2.digits;
	...
	public BigNumber trim(BigNumber num) {
	...
	BigNumber multiplySingleBit(BigNumber x, BigNumber y) {
	...
	public BigNumber powerUtil(BigNumber a, BigNumber n) {
	...
	public BigNumber power(BigNumber a, BigNumber n) {
	...
	BigNumber divisionBy2(BigNumber num) {
	...
	boolean isGreaterThan(BigNumber a, BigNumber b) {
		a = trim(a);
		b = trim(b);
	...
	boolean isLesserThan(BigNumber a, BigNumber b) {
		a = trim(a);
		b = trim(b);
	...
	boolean isEqual(BigNumber a, BigNumber b) {
		a = trim(a);
		b = trim(b);
	...
	public boolean getSignForProductNDivide(boolean a, boolean b) {
		if(a && b) return true;
	...
	public BigNumber mod(BigNumber a, BigNumber b) {
	...
	public BigNumber squareRoot(BigNumber a) {
	...
	public BigNumber factorial(BigNumber num) {
	...
	{
		BigNumber bignum = new BigNumber();
		BigNumber a = new BigNumber("987654321098765432109876543210987654321");
		BigNumber b = new BigNumber("-");
		
		System.out.println(bignum.power(a, 256L));
